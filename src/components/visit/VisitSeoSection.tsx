    ...
    <section className="bg-white px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl rounded-[2rem] bg-cream p-6 shadow-soft sm:p-8">
        <div className="max-w-4xl">
          <h2 className="font-serif text-3xl font-black text-charcoal sm:text-5xl">Bagels, breakfast, and cafe favorites in El Cajon</h2>
          <p className="mt-4 text-base font-bold leading-7 text-espresso/72">
            Golden Bagel Cafe serves fresh bagels, breakfast sandwiches, wraps, salads, smoothies, and cafe favorites from our
            Fletcher Parkway location in El Cajon.
          </p>
