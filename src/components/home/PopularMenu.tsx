...
import { featuredMenuItemIds, menuItems, type MenuItem } from "@/data/liveMenu";
...
export function PopularMenu() {
  return (
    <Section
      ...
      intro="Browse a few favorites here, then order online when you are ready to place a pickup order."
      className="bg-cream"
    >
