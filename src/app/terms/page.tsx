  ...
  return (
    <main className="bg-cream px-4 py-14 sm:px-6 lg:px-8">
      <article className="mx-auto max-w-3xl rounded-[2rem] bg-white p-6 leading-8 text-espresso/78 shadow-soft sm:p-10">
        ...
        <p className="mt-5">
          This website is provided for menu browsing, contact, event requests, job applications, newsletter signup, and
        ...
        <p className="mt-4">
          ...
          preparation until the online checkout flow is configured.
        </p>
